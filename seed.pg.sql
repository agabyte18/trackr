-- Given the following prisma model, generate SQL statement to insert 20 records in the Issue table. Use real-world titles and descriptions for issues. Status can be OPEN, IN_PROGRESS, or CLOSED. Descriptions should be one paragraph long. Provide different values for createdAt and updatedAt columns. Assume the underlying database is a Postgres database.
